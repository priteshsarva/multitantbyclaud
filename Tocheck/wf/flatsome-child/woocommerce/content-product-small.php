...
<li>
	<a href="<?php echo esc_url( get_permalink( $product->get_id() ) ); ?>" title="<?php echo esc_attr( $product->get_title() ); ?>">
		...
		<span class="product-title">
			<?php 
// 			echo $product->get_title(); // phpcs:ignore WordPress.Security.EscapeOutput 
			
	$title = get_title(); // Get the product title
	echo str_replace("_", " ", $title); // Replace underscores with spaces
